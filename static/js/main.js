...
=============================================*/
  function mainSlider() {
    ...
    BasicSlider.slick({
      ...
      fade: true,
      arrows: true,
      responsive: [{ breakpoint: 767, settings: { dots: true, arrows: true } }],
      prevArrow: "<i class='slick-prev flaticon-left-arrow'/>",
      nextArrow: "<i class='slick-next flaticon-right-arrow'/>",
    });
